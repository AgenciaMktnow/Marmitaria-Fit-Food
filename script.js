 window.addEventListener('load', function () {
  // Add botão Whatsapp (Dieta Personalizada) no menu
    ...
    const whatsapp=` <li class="header-actions__item account"><a id="btnWhatsNav">
...
function addEndereco() {
  ...
  function criaIMiniBanner(){
    ...
    <a style="display: flex; justify-content: center;" href="https://marmitaria-fit-food.lojaintegrada.com.br/kits-fitness">
        ...
        <img style="border-radius: 10px;" class="mini_mobile" src="https://cdn.awsli.com.br/2674/2674396/arquivos/mini-banner---kits-mobile-1.png"/>
    </a>`
...
function verificarFaixaCEP(cep) {
    ...
    var ceps = [
        { inicial: '01000000', final: '09999999' },
